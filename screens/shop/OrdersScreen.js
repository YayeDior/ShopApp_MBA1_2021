    ...
    if (error) {
        return (
            <View style={styles.centered}>
                <Text>Des erreurs se sont produites!</Text>
                <Button title="Réessayer!" onPress={loadOrders} color={Colors.primary}/>
            </View>
        )
    }
    ...
    if (orders.length === 0) {
        return (
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                <Text>Aucune commande trouvée, peut-être commencer à commander des produits!</Text>
            </View>
        );
    }
