                    ...
                    <ScrollView>
                        ...
                        <View style={styles.buttonContainer}>
                            {isLoading
                                ...
                                : <Button color={Colors.primary} title={isSignUp ? 'Inscription' : 'Connexion'} onPress={authHandler}/>}
                        </View>
                        <View style={styles.buttonContainer}>
                            <Button color={Colors.accent} title={`Switch to ${isSignUp ? 'Connexion' : 'Inscription'}`} onPress={() => {
